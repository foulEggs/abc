						...
						<div id="testmodal2" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input type="text" class="form-control form-controlNew" name="sign_name" data-rule-required="true" data-msg-required="请填写支付方式">
							...
							<div class="form-group">
								<div class="col-sm-8">
									...
									<div><input type="checkbox" name="accept_id[]" value="{{$vo->id}}">{{$vo->name}}</div>
									@endforeach
								</div>
							</div>
